...
public class GlobalCustomException {
    ...
    public MessageCustomGlobalException handle(MethodArgumentNotValidException exception) {

        List<ValidacaoDto> validacaoDtos = new ArrayList<>();
        MessageCustomGlobalException  customGlobalException = new MessageCustomGlobalException(
